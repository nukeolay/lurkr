...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: ScrollConfiguration( //убираю подсветку границ при скролле
                                        ...
                                        : Container(
                                            ...
                                            decoration: BoxDecoration(
                                              image: DecorationImage(
                                                image: NetworkImage(tempLoadedAccount.profilePicUrl.toString()),
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                            child: tempLoadedAccount.isPrivate == false
                                                ? Text('')
                                                : Center(
                                                    child: Container(
                                                      ...
                                                      child: BackdropFilter(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Center(child: Icon(Icons.lock_outline_rounded, color: Colors.red)),
                                                        ),
                                                      ),
                                                    ),
                                                  ),
