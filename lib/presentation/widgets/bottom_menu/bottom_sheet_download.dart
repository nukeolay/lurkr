      ...
      children: <Widget>[
        ...
        Row(
          children: [
            ...
            Container(
              margin: EdgeInsets.only(top: 0.0, bottom: 0.0, left: 0.0, right: 20.0),
              child: IconButton(
                padding: EdgeInsets.zero,
                tooltip: 'button_help_download'.tr(),
                icon: const Icon(Icons.help_outline_rounded, size: 40, color: Colors.green),
                onPressed: () {
        ...
        Container(
          ...
          child: MaterialButton(
              ...
              child: Container(
                ...
                alignment: Alignment.center,
                child:
                    Text('button_download'.tr(), style: TextStyle(color: Colors.white, fontFamily: 'Montserrat', fontSize: 16.0, fontWeight: FontWeight.w400)),
              ),
              onPressed: () {
                BlocProvider.of<AccountListBloc>(context).add(AccountListEventDownloadMedia(mediaRawUrl: _textFieldController.value.text));
                _textFieldController.clear();
                Navigator.pop(context);
              }),
        ),
